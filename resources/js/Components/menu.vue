        ...
        <template v-if="layoutType === 'vertical' || layoutType === 'semibox'">
            <ul class="navbar-nav h-100" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <Link class="nav-link menu-link" href="/announcements" role="button" aria-expanded="false"
                        aria-controls="Permission">
                    <i class="ri-dashboard-2-line"></i>

                    <span data-key="t-dashboards">Announcements</span>
                    </Link>
                </li>

                <li class="nav-item">

                    <Link class="nav-link menu-link" href="/galleries" role="button" aria-expanded="false"
                        aria-controls="Permission">
                    <i class="ri-dashboard-2-line"></i>
                ...
                <li class="nav-item">
                    ...
                    <Link class="nav-link menu-link" href="/enquiries" role="button" aria-expanded="false"
                        aria-controls="Permission">
                    <i class="ri-dashboard-2-line"></i>

                    <span data-key="t-dashboards">Enquires</span>
                    </Link>
                </li>
            </ul>
        </template>
